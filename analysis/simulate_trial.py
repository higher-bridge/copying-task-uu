...
def simulate_trial(tracking_dict:dict, k_items:int, 
                   visible_time:int, occlude_time:int,
                   intercept:float, coefficient:float,
                   intercept_mouse:float, coefficient_mouse:float,
                   n_repetitions:int, 
                   f:float, thresh:float, noise:float, decay:float,
