...
class Canvas(QWidget):
    ...
    def setConditionTiming(self):
        ...
        try:
            visibleTime, sigma = self.getConditionTiming()
        ...
        if self.addNoise and sigma != 0:
            ...
            noise = gauss(mu=1.0, sigma=sigma)

            self.occludedTime = int(visibleTime * noise)
            # self.visibleTime = sumDuration - occludedTime
            self.visibleTime = visibleTime
        else:
            self.visibleTime = visibleTime
            self.occludedTime = visibleTime
    ...
    def getConditionTiming(self):
        ...
        sigma = self.conditions[self.currentConditionIndex][1]

        return visibleTime, sigma
